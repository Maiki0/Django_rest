# Generated by Django 4.1.3 on 2022-12-21 01:21
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='products.categoryproduct', verbose_name='categorya de producto'),
        ),
        migrations.AddField(
            model_name='historicalproduct',
            name='measure_unit',
        ...
        migrations.AddField(
            model_name='product',
            name='category_product',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='products.categoryproduct', verbose_name='categorya de producto'),
        ),
        migrations.AddField(
            model_name='product',
            name='measure_unit',
        ...
        migrations.AlterField(
            model_name='historicalcategoryproduct',
            name='description',
            field=models.CharField(db_index=True, max_length=50, verbose_name='Descripcion'),
        ),
        migrations.AlterField(
            model_name='historicalproduct',
            name='image',
